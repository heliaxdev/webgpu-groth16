//! GPU-accelerated Groth16 zero-knowledge proof system with curve-pluggable abstractions.
//!
...
//! - [`glv`] — curve-specific GLV endomorphism implementations (where available).
//!
//! # MSM Pipeline
//!
//! G1 MSMs use curve-capability-aware Pippenger. For curves with GLV support,
//! each scalar is decomposed into `k1·P + k2·φ(P)`, halving the number of windows.
